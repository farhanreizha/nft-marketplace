...
const NftCreate: NextPage = () => {
  ...
  const createNft = async () => {
    try {
      ...
      const tx = await contract?.mintToken( nftURI, ethers.utils.parseEther(price), {
          ...
          <div className='flex'>
            ...
            <Switch
              ...
              className={`${hasURI ? 'bg-indigo-900' : 'bg-indigo-700'}
                  ...
                  flex-shrink-0 h-[28px] w-[64px] border-2 
            ...
            >
              ...
              <span
                ...
                className={`${hasURI ? 'translate-x-9' : 'translate-x-0'}
                    ...
                    rounded-full bg-white shadow-lg transform ring-0 transition ease-in-out duration-200`}
              />
            </Switch>
          </div>
        )}
            ...
            <form>
              <div className='shadow sm:rounded-md sm:overflow-hidden'>
                <div className='px-4 py-5 bg-white space-y-6 sm:p-6'>
                  ...
                  { nftMeta.image ? (
                    <img
                      src={nftMeta.image} alt='' className='h-40' />
                  ) : (
                    <div>
                  ...
                  <p className='text-sm !mt-2 text-gray-500'>Choose value from 0 to 100</p>
                </div>
                <div className='px-4 py-3 bg-gray-50 text-right sm:px-6'>
                  <button
