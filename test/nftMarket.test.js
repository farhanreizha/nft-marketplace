...
contract('NftMarket', (accounts) => {
  ...
  describe('Mint token', () => {
    ...
    it('first token sould point to the correct tokenURI', async () => {
    ...
    it('should have create NFT item', async () => {
      ...
      assert.equal(nftItem.price, _nftPrice, 'Nft Prife is not correct')
  ...
  //   it('account[2] should owne 0 Nft', async () => {
